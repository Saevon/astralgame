...
import static jpb.AnsiString.Colour.BLUE;
import static jpb.AnsiString.Colour.CYAN;
import static jpb.AnsiString.Colour.GREEN;
import static jpb.AnsiString.Colour.PURPLE;
import static jpb.AnsiString.Colour.RED;
import static jpb.AnsiString.Colour.YELLOW;
 ...
 * @version $Revision: 1.1 $ $Date: 2005/03/09 03:53:16 $ $Name: release_0_0_8_alpha $
 */
public class AnsiString implements java.io.Serializable {
    ...
    public static final String RED_ESC = "\033[1;31m";

    /** <font color="green">escape sequence for green </font> */
   public static final String GREEN_ESC = "\033[1;32m";

    /** <font color="blue">escape sequence for blue </font> */
    public static final String BLUE_ESC = "\033[1;34m";

    /** <font color="purple">escape sequence for purple </font> */
    public static final String PURPLE_ESC = "\033[1;35m";
